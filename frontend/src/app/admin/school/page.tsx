...
import { Building2, Save, MapPin, Phone, Globe, Upload, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-slate-500 mt-1">Manage global school information and academic settings.</p>
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form onSubmit={handleSave} className="p-6 space-y-6">
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            <div className="w-32 h-32 rounded-2xl bg-slate-100 border-2 border-dashed border-slate-300 flex flex-col items-center justify-center shrink-0 relative overflow-hidden group">
              <span className="text-slate-400 font-bold text-4xl">LOGO</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-100">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea id="address" value={formData.address} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border bg-slate-50 outline-none" rows={3} required></textarea>
              </div>
